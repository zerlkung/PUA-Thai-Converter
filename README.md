...
> **สำคัญ:** ต้องมีฟอนต์ PUA ของเกมเอง — หาได้จากโฟลเดอร์เกมที่ติดตั้งไว้
> 
> **ฟอนต์ .ttf / .otf:** ใช้ได้ทันที ไม่ต้องตั้งค่าเพิ่ม ชื่อไฟล์มักมีคำว่า `Medium`, `SST`, `Condensed` หรือคล้ายกัน ฟอนต์เหล่านี้ใช้ PUA codepoint ช่วง U+F000–U+F89F แทนอักขระไทย
> 
> **ฟอนต์ .gfx:** ต้องเพิ่ม PUA characters ในช่อง Add Font ด้านล่างของโปรแกรม โดย paste ตัวอักษร PUA ทั้งหมดลงไป (เช่น ... ตัดมาจาก `_unique_pua_chars.txt` ก็ได้) เพื่อให้โปรแกรมรู้ว่าฟอนต์นี้รองรับอักขระใดบ้าง
